...
import com.siui.sysapp.applock.views.Directions.HideType;
import com.siui.sysapp.applock.views.Directions.ShowType;
...
public class BlurLockView extends FrameLayout
    ...
    private OnMidButtonClickListener onMidButtonClickListener;
    ...
    private void init() {
        ...
        midButton = (TextView)findViewById(R.id.mid_button);
        midButton.setTextColor(ContextCompat.getColor(getContext(), R.color.default_mid_button_text_color));
        midButton.setTextSize(resources.getInteger(R.integer.default_mid_button_text_size));
        midButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (onMidButtonClickListener != null) onMidButtonClickListener.onClick();
            }
        });
    }
    ...
    public void setOnMidButtonClickListener (OnMidButtonClickListener onMidButtonClickListener) {
        this.onMidButtonClickListener = onMidButtonClickListener;
    }
    ...
    public void setMidButton(String string) {
        midButton.setText(string);
    }
    ...
    public interface OnMidButtonClickListener {
        void onClick();
    }
